...
$sql = "SELECT * FROM users WHERE NOT unique_id = {$outgoing_id} ORDER BY user_id DESC"; // SQL query to retrieve all users except the current user, ordered by user ID in descending order
